...
function OrientacoesView({settings}){
  ...
  const steps=[
    ...
    {n:5,title:"Entregáveis derivados",body:"Define o que será extraído do modelo 3D (documentação/extração de formatos, lista de materiais (BOM), relatórios de clash (interferências), modelo federado)."},
